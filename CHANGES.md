...
- T18: Added release-distribution scaffolding with PyInstaller spec, `tools/release.py` artifact builder, and package-manager templates for winget/homebrew/Linux plus source-install documentation.
